...
- 🌟 Founding AI Product Engineer @ **Myna AI (Techstars ’24)** – took a multi-agent conversational platform from 0→1 to serving **500+ hotels**, helping secure **>$1M raised**.  
- 🧠 Built a **self-onboarding voice platform** so non-technical owners can launch a custom agent in ~5 minutes, and designed **Myna Score** to gamify consulting, ROI, and upsell conversations.  
- ⚙️ I care about the *boring but critical* bits: low-latency voice agents (<2s p95), cloud-native architectures (AWS/K8s), observability (OpenTelemetry, Prometheus, Grafana), and Responsible AI (guardrails, evals, PII).  
...
![Kinesis](https://img.shields.io/badge/AWS%20Kinesis-FF4F00?style=for-the-badge&logo=amazonaws&logoColor=white)
...
- 💼 Open to: **AI Engineer, ML Engineer, Agentic / Voice AI, Cloud-native AI platform** roles  
- 🧪 Love collaborating on: multi-agent systems, low-latency voice assistants, and human-centric AI/HRI  
- 🧭 Portfolio: [labeebzahed.vercel.app](https://labeebzahed.vercel.app)  
- 📫 Reach me: **labeebzahed@gmail.com** · [LinkedIn](https://www.linkedin.com/in/labeebzahed/)

<div align="center">

_if you made it this far, drop a ⭐ on something you liked – and ping me if you want to build something wild together._
